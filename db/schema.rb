...
ActiveRecord::Schema.define(version: 20221217175419) do

  # These are extensions that must be enabled in order to support this database
  enable_extension "plpgsql"

  create_table "abastes", force: :cascade do |t|
    t.string   "code"
    t.datetime "fecha"
  ...
  create_table "bankdeposits", force: :cascade do |t|
    t.string   "fecha"
    t.string   "code"
  ...
  create_table "devols", force: :cascade do |t|
    t.string   "cod_prod"
    t.datetime "fecha"
    t.string   "documento"
    t.string   "observa"
  ...
  create_table "pumps", force: :cascade do |t|
    ...
    t.integer  "tanque_id"
    t.integer  "island_id"
    t.integer  "id_surtidor"
    t.integer  "id_posicion_manguera"
  end
  ...
  create_table "tirads", force: :cascade do |t|
    t.integer  "employee_id"
    t.integer  "turno"
    t.datetime "fecha"
    t.float    "importe"
  ...
  create_table "tmpasistens", force: :cascade do |t|
    t.integer  "dia_month"
    t.string   "cod_emp"
    t.integer  "turno"
    t.datetime "created_at", null: false
