...
resources :tranportorders do
 ...
 # get 'search_friends', to: 'deliveries#search'
  ...
  match 'companies/reports/rpt_facturas_10/:company_id' => 'reports#rpt_facturas_10', via: [:get, :post]
...
# Declarations
  ...
  match 'facturas/ac_documentos/:company_id' => 'facturas#ac_documentos', via: [:get, :post]
  ...
  match 'facturas/rpt_salidas2_all_pdf/:company_id' => 'facturas#rpt_salidas2_all_pdf', via: [:get, :post]
